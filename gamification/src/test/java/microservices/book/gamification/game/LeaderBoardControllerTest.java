...
public class LeaderBoardControllerTest {
    ...
    public void getLeaderBoardTest() throws Exception {
        // given
        LeaderBoardRow leaderBoardRow1 = new LeaderBoardRow(UUID.randomUUID().toString(), 500L);
        LeaderBoardRow leaderBoardRow2 = new LeaderBoardRow(UUID.randomUUID().toString(), 400L);
