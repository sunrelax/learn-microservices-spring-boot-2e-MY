...
public class GameServiceImplTest {
    ...
    public void processCorrectAttemptTest() {
        // given
        String userId = UUID.randomUUID().toString(), attemptId = UUID.randomUUID().toString();
    ...
    public void processWrongAttemptTest() {
        ...
        GameResult gameResult = gameService.newAttemptForUser(
                new ChallengeSolvedEvent(UUID.randomUUID().toString(), false, 10, 10, UUID.randomUUID().toString(), "john")
        );
